...
<div class="actions-bar">
    <form method="GET" action="{{ route('admins.index') }}" class="search-container">
        ...
        <input type="text" name="q" placeholder="Pesquisar Planos..." value="{{ request('q') }}">
    </form>

    <a href="{{ route('planos.create') }}" class="add-button">
...
<div class="table-container">
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $plano->user->id }}</td>
                <td>{{ $plano->user->nome }}</td>
                <td>{{ $plano->user->cpf }}</td>
                <td>{{ $plano->user->email }}</td>
                <td>{{ $plano->telefone }}</td>
                <td>
                    <div class="action-buttons">
                        <a href="{{ route('planos.show', $plano) }}" class="action-button" title="Visualizar">
                            <i class="fas fa-eye"></i>
                        </a>
                        <a href="{{ route('planos.edit', $plano) }}" class="action-button edit-button" title="Editar">
