...
<body>
    ...
    <div class="container">
        ...
        <nav class="sidebar">
            ...
            <ul class="nav-links">
                <li>
                    <a href="inicio.html" title="Início">
                        <i class="fas fa-home"></i><span>Início</span>
                    </a>
                </li>
                <li>
                    <a href="aulas.html" title="Aulas">
                        <i class="fas fa-calendar-alt"></i><span>Aulas</span>
                    </a>
                </li>
                <li class="active">
                    <a href="comunicados.html" title="Comunicados">
                        <i class="fas fa-bullhorn"></i><span>Comunicados</span>
                    </a>
                </li>
                <li>
                    <a href="financeiro.html" title="Financeiro">
                        <i class="fas fa-wallet"></i><span>Financeiro</span>
                    </a>
                </li>
                <li>
                    <a href="suporte.html" title="Suporte">
                        <i class="fas fa-headset"></i><span>Suporte</span>
                    </a>
                </li>
                <li class="sidebar-bottom">
                    <a href="configuracoes.html" title="Configurações">
