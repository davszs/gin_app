...
<body><!-- Estrutura principal -->
    <div class="container"><!-- Menu Lateral -->
        <nav class="sidebar">
            <div class="logo"><a href="#"><i class="fas fa-dumbbell"></i></a></div>
            <ul class="nav-links">
                <li class="active"><a href="inicio.html" title="Início"><i
                            class="fas fa-home"></i><span>Início</span></a></li>
                <li><a href="aulas.html" title="Aulas"><i class="fas fa-calendar-alt"></i><span>Aulas</span></a></li>
